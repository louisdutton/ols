...
ast_for_in_identifier_completion :: proc(t: ^testing.T) {
	...
	test.expect_completion_docs(
		...
		&source,
		"",
		{"test.my_element: test.My_Struct"},
	)
}
...
ast_value_decl_comp_lit_infer_with_maybe :: proc(t: ^testing.T) {
	...
	test.expect_completion_docs(
		...
		&source,
		"",
		{"Inner.a: int", "Inner.b: int", "Inner.c: int"},
	)
}
...
ast_index_proc_parameter_completion :: proc(t: ^testing.T) {
	...
	test.expect_completion_docs(
		...
		&source,
		".",
		{"test.param: my_package.My_Struct"},
	)
}
...
ast_complete_ptr_using :: proc(t: ^testing.T) {
	...
	test.expect_completion_docs(
		...
		&source,
		"",
		{`A.b: ^test.B`, `A.a: ^struct {..}`, `A.foo: int`, `A.f: int`},
	)
}
...
@(test)
ast_completion_enumerated_array_should_exclude_already_added :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_completion_struct_field_value_when_not_specifying_type_at_use_implicit :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_completion_bitset_named_proc_arg_should_remove_already_used :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
ast_completion_bit_set_in_not_in :: proc(t: ^testing.T) {
	...
	test.expect_completion_docs(
		...
		&source,
		"",
		{".A in foos", ".A not_in foos", ".B in foos", ".B not_in foos"},
	)
}
...
@(test)
ast_completion_proc_bit_set_comp_lit_default_param_with_no_type :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_completion_overload_proc_returning_proc_complete_comp_lit_arg_local :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
	...
	test.expect_completion_docs(
		...
		&source,
		"",
		{"Foo.bar: int", "Foo.bazz: string"},
	)
}

@(test)
ast_completion_overload_proc_returning_proc_complete_comp_lit_arg_direct :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_completion_implicit_selector_enumerated_array_value :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_completion_implicit_selector_enumerated_array_in_proc_call_arg :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
