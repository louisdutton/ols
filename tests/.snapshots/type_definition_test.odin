...
@(test)
ast_type_definition_struct_field_definition_from_declaration :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_type_definition_procedure_mulitple_return_first_value :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_type_definition_procedure_mulitple_return_second_value :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_type_definition_struct_field_definition_from_declaration_builtin_type :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_type_definition_on_proc_with_multiple_return_goto_first_return :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_type_definition_external_package_from_proc_slice_return :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
...
@(test)
ast_type_definition_external_package_from_external_proc :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
...
@(test)
ast_type_definition_proc_named_param_with_default_value :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_type_definition_polymorphic_type_with_specialization :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
