...
ast_hover_procedure_with_default_comp_lit :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.fa :: #type proc(color_: Color = {255, 255, 255, 255})",
	)
}
...
ast_hover_proc_overloading_no_params :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: proc(allocator := context.allocator) -> (_: int, _: bool)",
	)
}
...
ast_hover_proc_overloading_named_arguments :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: proc(i: int, s := \"hello\") -> (_: int, _: bool)",
	)
}
...
@(test)
ast_hover_distinguish_names_correctly_variable_assignment :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_proc_overloading_named_arg_with_selector_expr_with_another_package :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
	...
	test.expect_hover(
		t,
		&source,
		"my_package.foo :: proc(x := 1) -> (_: int, _: bool)\n---\nDocs\n---\ncomment",
	)
}

@(test)
ast_hover_proc_overloading_named_arg_with_selector_expr_multiple_packages :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
...
@(test)
ast_hover_proc_overloading_parametric_type_external_package :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
...
@(test)
ast_hover_poly_type_external_package_with_external_type :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
...
ast_hover_struct_poly_type_external_package :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foos: small_array.Small_Array(MAX, Foo)",
	)
}
...
@(test)
ast_hover_struct_fields_when_not_specifying_type_at_use :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_value_when_not_specifying_type_at_use :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_overload_proc_strings_from_different_packages :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_field :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_struct_types :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_procs :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_named_procs :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_maps :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_bit_sets :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
	...
	test.expect_hover(
		t,
		&source,
		"Foo.bar: bit_set[0 ..< 10]\n---\nbar docs\n---\nbar comment",
	)
}

@(test)
ast_hover_struct_field_should_show_docs_and_comments_unions :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_multipointers :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_dynamic_arrays :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_fixed_arrays :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_struct_field_should_show_docs_and_comments_matrix :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
ast_hover_proc_force_inline :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: #force_inline proc(a: int) -> int",
	)
}
...
ast_hover_proc_force_no_inline :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: #force_no_inline proc(a: int) -> int",
	)
}
...
ast_hover_struct_tags_packed :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.Foo :: struct($T: typeid) #packed #all_or_none {}",
	)
}
...
ast_hover_struct_tags_align :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.Foo :: struct($T: typeid) #align(4) {}",
	)
}
...
ast_hover_struct_tags_field_align :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.Foo :: struct #max_field_align(4) #min_field_align(2) {}",
	)
}
...
@(test)
ast_hover_parapoly_elem_overloaded_proc_multiple_options :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
@(test)
ast_hover_proc_call_implicit_selector_with_default_value :: proc(
	t: ^testing.T,
) {
	source := test.Source {
		main = `package test
...
ast_hover_parapoly_proc_with_where_clause :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: proc(x: [$N]int) -> bool where N > 2 #optional_ok",
	)
}
...
ast_hover_proc_group_variadic_args :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.append :: proc(array: ^$T/[dynamic]string, args: ..string)",
	)
}
...
ast_hover_proc_group_variadic_args_with_generic_type :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.append :: proc(array: ^$T/[dynamic]$E, args: ..E)",
	)
}
...
ast_hover_proc_group_with_generic_type_from_proc_param :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.append :: proc(array: ^$T/[dynamic]$E, arg: E)",
	)
}
...
ast_hover_proc_param_tags :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: proc(#by_ptr a: int, #any_int b: int)",
	)
}
...
@(test)
ast_hover_package_proc_naming_conflicting_with_another_package :: proc(
	t: ^testing.T,
) {
	packages := make([dynamic]test.Package, context.temp_allocator)
...
ast_hover_proc_return_with_struct :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: proc() -> struct{s: string, i: int}",
	)
}
...
ast_hover_proc_arg_generic_bit_set :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: proc($T: typeid/bit_set[$F; $E])",
	)
}
...
ast_hover_proc_overload_with_less_args :: proc(t: ^testing.T) {
	...
	test.expect_hover(
		t,
		&source,
		"test.foo :: proc(input: int) -> (out_struct: Foo, ok: bool)",
	)
}
